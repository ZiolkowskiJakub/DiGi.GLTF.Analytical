...
Converts a [DiGi\.Analytical\.Building\.Classes\.BuildingModel](https://learn.microsoft.com/en-us/dotnet/api/digi.analytical.building.classes.buildingmodel 'DiGi\.Analytical\.Building\.Classes\.BuildingModel') into [DiGi\.GLTF\.Classes\.GLTFNode](https://learn.microsoft.com/en-us/dotnet/api/digi.gltf.classes.gltfnode 'DiGi\.GLTF\.Classes\.GLTFNode') instances by converting all of its components \(see [Convert\.ToGLTF\_GLTFNodes\(BuildingModel?, double, BuildingModelDetailLevel\)](https://learn.microsoft.com/en-us/dotnet/api/convert.togltf_gltfnodes#convert-togltf_gltfnodes(buildingmodel?-double-buildingmodeldetaillevel) 'Convert\.ToGLTF\_GLTFNodes\(BuildingModel?, double, BuildingModelDetailLevel\)')\)\.
